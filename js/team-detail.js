...
const teamMembers = {
    ...
    'xing-baishun': {
        ...
        paragraphs: [
            `邢百顺，男，汉族，共青团员，2001年生于安徽合肥，现为安徽大学资源与环境工程学院环境工程专业硕士研究生，硕士学位论文题目为《特异性噬菌体介导的垃圾填埋场氢营养型产甲烷古菌产甲烷的机制研究》。`,
    ...
    'fang-shuqi': {
        ...
        paragraphs: [
            `方书琪，女，2002年生于安徽淮南，现为安徽大学资源与环境工程学院硕士研究生，硕士学位论文为《特异性噬菌体介导的垃圾填埋场乙酸营养型产甲烷古菌产甲烷的机制研究》。`,
    ...
    'yang-jialiang': {
        ...
        paragraphs: [
            `杨嘉梁，男，2000年生于湖北武汉，现为安徽大学资源与环境工程学院硕士研究生，硕士学位论文为《Zobellella taiwanensis DN-7 去除垃圾渗滤液中高氨氮的工程化应用研究》。`,
            `研究聚焦高氨氮渗滤液处理的工程应用。`
        ]
    },
    'gong-zhourui': {
